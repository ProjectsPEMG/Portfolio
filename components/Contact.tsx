      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <a href="https://www.linkedin.com/in/paul-emile-martin-grandvoinnet-4447a02a0/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">
              Voir mon profil
            </a>
          </motion.div>
